...
const uint8_t PIN_LED_YELLOW = 9;
...
const uint8_t PIN_SWITCH_A = 2;
const uint8_t PIN_SWITCH_B = 3;
const uint8_t PIN_SWITCH_C = 4;
const uint8_t PIN_SWITCH_D = 5;
const uint8_t PIN_MISO = 12;
const uint8_t PIN_SCK = 13;

// Tone constants for the buzzer
